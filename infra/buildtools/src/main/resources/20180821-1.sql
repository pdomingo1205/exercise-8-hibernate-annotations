...
ADD CONSTRAINT person_pkey PRIMARY KEY (person_id)s;
...
ADD CONSTRAINT fk_q77uyvqapotysf04dtjhy6np8 FOREIGN KEY (person_id) REFERENCES person(person_id);
